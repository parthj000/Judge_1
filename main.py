...
def lambda_handler(event,context):
    ...
    with open("temp.py","w") as file:
        file.write(code)
    try:
        result = subprocess.run(["python3","solution.py",test_cases_str],capture_output=True,text=True,timeout=5,preexec_fn=set_memory_limit)
